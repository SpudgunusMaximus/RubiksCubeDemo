...
{
    public class RightAntiClockwiseHandler : RotationHandlerBase, IRotationHandler
    {
        public RightAntiClockwiseHandler(IEnumerable<Face> faces) : base(faces, FaceType.Right, RotationType.AntiClockwise) { }
