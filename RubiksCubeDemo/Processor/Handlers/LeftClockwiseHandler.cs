...
{
    public class LeftClockwiseHandler : RotationHandlerBase, IRotationHandler
    {
        public LeftClockwiseHandler(IEnumerable<Face> faces) : base(faces, FaceType.Left, RotationType.Clockwise) { }
