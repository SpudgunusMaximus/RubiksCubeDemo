...
{
    public class DownClockwiseHandler : RotationHandlerBase, IRotationHandler
    {

        public DownClockwiseHandler(IEnumerable<Face> faces) : base(faces, FaceType.Down, RotationType.Clockwise) { }
