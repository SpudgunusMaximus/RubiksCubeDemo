...
{
    internal class DownClockwiseHandler : RotationHandlerBase, IRotationHandler
    {

        public DownClockwiseHandler(List<Face> faces) : base(faces, FaceType.Down, RotationType.Clockwise) { }
