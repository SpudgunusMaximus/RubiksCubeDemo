...
{
    public class UpAntiClockwiseHandler : RotationHandlerBase, IRotationHandler
    {
        public UpAntiClockwiseHandler(IEnumerable<Face> faces) : base(faces, FaceType.Up, RotationType.AntiClockwise) { }
