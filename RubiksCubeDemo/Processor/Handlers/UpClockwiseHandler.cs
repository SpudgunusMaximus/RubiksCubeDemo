...
{
    internal class UpAntiClockwiseHandler
    {
        private readonly List<Face> _faces;

        public UpAntiClockwiseHandler(List<Face> faces)
        {
            _faces = faces;
        }
